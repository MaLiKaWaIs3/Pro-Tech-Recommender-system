...
const Header = ({ open, handleDrawerOpen, headerTitle }) => {
  ...
  return (
    <AppBar position="fixed" open={open} style={{ backgroundColor: '#3b3939', color: "white", boxShadow: "None" }} >
      <Toolbar>
        <IconButton
          color="inherit"
        ...
        <Typography variant="h4" noWrap component="div" onClick={redirectToHome} sx={{ flexGrow: 1, fontWeight: 'bolder' }} >
          <div className='d-flex headerlogo' >
          ...
          <div className={styles.accountIcon}>
            ...
            >
              ...
              <div style={{ display: 'flex', flexDirection: "column", alignItems: "start" }} >
                <span style={{ fontSize: 19, color: 'white', marginTop: 3 }} > {currentUser.firstName} {currentUser.lastName}</span>
