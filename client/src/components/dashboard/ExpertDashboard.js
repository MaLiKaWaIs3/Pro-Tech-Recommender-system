		...
		<Box className={styles.dashboardBody} component="main" sx={{ flexGrow: 1, p: 3 }}>
			<div id={styles.welcomeBanner}>
				<div className='text-dark'>
					<h3 >Welcome!</h3>
					<br/>
					<h4> Exp. {currentUser.firstName} {currentUser.lastName} </h4>
					<br/>
					<div class={styles.horizontalLine}></div>
					At Planner, we believe that every Student deserves the highest recommendations. 
					<br/>
					Our commitment to excellence in idea recommendation is matched only by our compassion for those we serve.
