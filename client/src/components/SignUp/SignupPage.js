...
function SignupPage() {
  ...
  return (
    <div id={styles.signUpBody}>
      ...
      <div>
        <h2 className='text-center text-white mt-3'>Create An Account</h2>
        <form id={styles.signUpform} name='signUpform' onSubmit={handleSubmit}>
          <div className='d-flex flex-column flex-lg-row flex-sm-column mt-2'>
          ...
          <div className='form-floating mt-3 col-12 mx-2'>
            ...
            >
              ...
              <option value="Doctor">Expert</option>
          ...
          <div className='text-center text-white fw-bold mb-5 mt-1'>
            Already have an account? <NavLink to="/login" className="px-3" exact >Sign In</NavLink>
          </div>
